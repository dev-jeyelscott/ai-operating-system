...
function triggerDeterministicRework(projectSlug: string): ReworkResult {
    const php = [
        ...
        `    throw new \\RuntimeException('The request-changes ticket was not selected for deterministic rework.');`,
        `}`,
        `app(\\App\\Application\\Development\\ProcessDevelopmentExecution::class)->handle(`,
        `    execution: $execution,`,
        `    scenario: 'happy_path',`,
        `    seed: 1114,`,
        `);`,
