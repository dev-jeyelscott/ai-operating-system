...
/**
 * Generates irreversible circuit scopes without exposing Codex credentials.
 */
final class CodexCircuitScope
{
    /**
    ...
    public function forCredential(
        ...
        if (! is_string($applicationKey) || trim($applicationKey) === '') {
            throw new LogicException(
                'APP_KEY is required to derive Codex circuit scopes.',
            );
        }
