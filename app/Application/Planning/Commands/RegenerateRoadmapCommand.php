...
final readonly class RegenerateRoadmapCommand implements IdempotentCommand
{
    ...
    {
        return sprintf('organization:%d:project:%d:roadmap:%d:regenerate', $this->organizationId, $this->projectId, $this->roadmapId);
    }
    ...
    public function idempotencyPayload(): array
    {
        return [
            ...
            'feedback_fingerprint' => RoadmapCommandFingerprint::make(trim($this->feedback)),
        ];
    }
}
