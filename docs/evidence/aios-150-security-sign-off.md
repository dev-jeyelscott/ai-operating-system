# Historical AIOS-150 Security Sign-off Evidence

This repository record is historical and invalidated. Candidate-specific
security evidence is generated by the `release-candidate` workflow, checksummed
as a GitHub artifact, and approved through AIOS-294 without changing the
reviewed commit.
