...
| [Codex execution ADR](adr/0008-use-codex-app-server-with-laravel-managed-isolated-execution.md) | Codex transport, control-plane, execution-isolation, approval, evidence, and recovery decision | Engineers, architects, security, operations | System architect | 2026-08-04 | Codex transport, capability, sandbox, credential, repository-write, merge, or deployment change |
| [Codex threat-model appendix](security/codex-execution-threat-model-appendix.md) | Codex-specific threats, trust boundaries, security controls, and rollout gates | Security, engineers, operations | Security reviewer | 2026-08-04 | Provider, process, sandbox, command, network, credential, workspace, or repository-side-effect change |
...
| [Security documentation](security/threat-model.md) | MVP threat model and security controls | Security, engineers | Security reviewer | 2026-08-03 | New integration capability, trust-boundary, or privileged-operation change |
...
| [Evidence](evidence/) | Reviewed acceptance and security evidence | Release reviewers | Release manager | 2026-08-04 | New candidate or evidence invalidation |
